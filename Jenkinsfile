pipeline {
    ...
    stages {
        ...
        stage('Build Linux Binary') {
            agent { label 'fedora' }  // Eğer başka bir ajan kullanıyorsanız, burayı değiştirebilirsiniz
            steps {
                script {

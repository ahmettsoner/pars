...
func (s ResourceEngine) CreateResourcesFromTemplate(init bool, data any, resourceFiles ...string) error {
	...
	for _, resourceFilePath := range resourceFiles {
		...
		groupSerializer := ResourceSerializer{}
...
func (s ResourceEngine) CreateResourcesFromFile(init bool, files ...string) error {
	if len(files) > 0 {
...
func (s ResourceEngine) RemoveResourcesFromFile(permanent bool, files ...string) error {
	if len(files) > 0 {
...
func (s ResourceEngine) CreateResources(resources []dataresource.ResourceBaseStruct, init bool) error {
...
func (s ResourceEngine) RemoveResources(resources []dataresource.ResourceBaseStruct, permanent bool) error {
...
func (s ResourceEngine) Generate(model dataresource.ResourceBaseStruct) (*dataresource.ResourceBaseStruct, error) {

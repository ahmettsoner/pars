...
func (s FileTemplateEngine) Validate(data []structs.Schema) bool {
...
func (s FileTemplateEngine) Process(data []structs.Schema) error {
...
func (s FileTemplateEngine) Destroy(data []structs.Schema) error {
	filetemplates := make([]filetemplateStruct.TemplateBaseStruct, 0, len(data))

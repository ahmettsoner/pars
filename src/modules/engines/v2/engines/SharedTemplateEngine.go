...
func (s SharedTemplateEngine) Validate(data []structs.Schema) bool {
...
func (s SharedTemplateEngine) Process(data []structs.Schema) error {
...
func (s SharedTemplateEngine) Destroy(data []structs.Schema) error {
	sharedtemplates := make([]sharedtemplateStruct.TemplateBaseStruct, 0, len(data))

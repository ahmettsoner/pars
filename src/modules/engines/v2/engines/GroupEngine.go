...
func (s GroupEngine) Validate(data []structs.Schema) bool {
...
func (s GroupEngine) Process(data []structs.Schema) error {
...
func (s GroupEngine) Destroy(data []structs.Schema) error {
	groups := make([]groupStruct.GroupBaseStruct, 0, len(data))

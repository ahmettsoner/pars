...
func (s ObjectResourceEngine) Validate(data []structs.Schema) bool {
...
func (s ObjectResourceEngine) Process(data []structs.Schema) error {
...
func (s ObjectResourceEngine) Destroy(data []structs.Schema) error {
	objectresourceStructs := make([]objectresourceStruct.ResourceBaseStruct, 0, len(data))

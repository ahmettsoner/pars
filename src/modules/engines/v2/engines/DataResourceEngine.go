...
func (s DataResourceEngine) Validate(data []structs.Schema) bool {
...
func (s DataResourceEngine) Process(data []structs.Schema) error {
...
func (s DataResourceEngine) Destroy(data []structs.Schema) error {
	dataresourceStructs := make([]dataresourceStruct.ResourceBaseStruct, 0, len(data))

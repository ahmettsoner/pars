...
func (s CommonTaskEngine) Validate(data []structs.Schema) bool {
...
func (s CommonTaskEngine) Process(data []structs.Schema) error {
...
func (s CommonTaskEngine) Destroy(data []structs.Schema) error {
	commontasks := make([]commontaskStruct.TaskBaseStruct, 0, len(data))

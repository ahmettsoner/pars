...
func (s CodeTemplateEngine) Validate(data []structs.Schema) bool {
...
func (s CodeTemplateEngine) Process(data []structs.Schema) error {
...
func (s CodeTemplateEngine) Destroy(data []structs.Schema) error {
	codetemplates := make([]codetemplateStruct.TemplateBaseStruct, 0, len(data))

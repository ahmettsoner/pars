...
func NewProjectSpecification(
	...
	return ProjectSpecification{
		ProjectIdentifier: NewProjectIdentifier(id, name, path, group, workspace),
...
func (s *ProjectSpecification) AppendReferences(references ...Reference) {
...
func (s *ProjectSpecification) UnmarshalYAML(unmarshal func(interface{}) error) error {
	...
	var tempObject struct {
		...
		Dependencies []Dependency        `yaml:"Dependencies"` //Burda inline defination eklenmeli, "gopkg.in/yaml.v3@v3.0.1, gopkg.in/gorm" gibi
	...
	for _, ref := range tempObject.References {
		reference := NewReference(
			schemas.NewSchemaHeader(schemas.StructTypes.Project, "", ref.Name, schemas.Metadata{}),

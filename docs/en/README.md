...
1. Clone the repository:
    ...
    cd pars
    ```
2. Follow the setup instructions provided in the [Installation Guide](https://docs.parsdevkit.net/setup/installation/installation.html).
...
-   ❓ [FAQs](FAQ.md)
-   📜 [CoC (Code of Conduct)](CODE_OF_CONDUCT.md)
-   🗒️ [Release Notes](CHANGELOG.md)
...
-   💖 [Sponsors and Backers](https://github.com/parsdevkit/pars/blob/main/../sponsors.md)
-   🚩 [Milestones](https://github.com/parsdevkit/pars/milestones)
-   🗂️ [Project Board](https://github.com/parsdevkit/pars/projects)
-   🐛 [Issues](https://github.com/parsdevkit/pars/issues)

...
foreach(CHOCOARCH ${ALL_CHOCOARCH_LIST_WINDOWS})
    ...
    set(CHOCO_ROOT_DIR ${CMAKE_SOURCE_DIR}/${DIST_ROOT_DIR}/${APP_TAG}/${OS_WINDOWS}/pkg/${CHOCO_PACKAGE_NAME}/${APP_ARCH})
    ...
    if(${CHOCOARCH} STREQUAL ${CHOCO_ARCH_ALL})
        ...
        set(BIN_OUTPUT_FULL_PATH ${CHOCO_OUTPUT_DIR}/${APP_NAME}/${DIST_ROOT_DIR}/${APP_TAG}/${OS_WINDOWS}/bin/${HOST_ARCH}/${APP_NAME}${EXT})
    else()
        set(BIN_OUTPUT_FULL_PATH ${CHOCO_OUTPUT_DIR}/${APP_NAME}/${DIST_ROOT_DIR}/${APP_TAG}/${OS_WINDOWS}/bin/${APP_ARCH}/${APP_NAME}${EXT})
    endif()
